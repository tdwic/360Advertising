...
<head>
    ...
    <link rel="stylesheet" href="css/style-services.css"><!--uniqe css file for this page only file-->
    ...
    <div class="home">
      ...
      <nav class="navbar navbar-expand-md fixed-top"> <!--Navbar coding segment starting-->
        <div class="container-fluid main-topic" >
          <a class="navbar-brand" href="index.jsp"><img src="image/logo2.png" class="img-fluid pull-xs-left" alt="..."></a> <!--navbar page logo class-->
