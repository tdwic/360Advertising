        ...
        <div class="container main-display">
          <div class="row">
            <div class="col-md-4 col-lg-4">
              <a href="image/print1.jpg">
                <picture>
                    <img src="image/print1.jpg" class="img-fluid  img1" alt="...">
                </picture>
              </a>
            </div>
            <div class="col-md-4 col-lg-4">
              <a href="image/print2.jpg">
                <picture>
                    <img src="image/print2.jpg" class="img-fluid  img2" alt="...">
                </picture>
              </a>
            </div>
            <div class="col-md-4 col-lg-4">
              ​<a href="image/print3.jpeg">
                <picture>
                    <img src="image/print3.jpeg" class="img-fluid  img3" alt="...">
                </picture>
              </a>
            </div>
          </div>
          <div class="row">
            <div class="col-md-3 col-lg-3">
              <a href="image/print4.jpg">
                <picture>
                    <img src="image/print4.jpg" class="img-fluid  img4" alt="...">
                </picture>
              </a>
            </div>
            <div class="col-md-3 col-lg-3">
              ​<a href="image/print5.jpg">
                <picture>
                    <img src="image/print5.jpg" class="img-fluid  img5" alt="...">
                </picture>
              </a>
            </div>
            <div class="col-md-3 col-lg-3">
              <a href="image/print6.jpg">
                <picture>
                    <img src="image/print6.jpg" class="img-fluid  img6" alt="...">
                </picture>
              </a>
            </div>
            <div class="col-md-3 col-lg-3">
              ​<a href="image/print7.jpg">
                <picture>
                    <img src="image/print7.jpg" class="img-fluid  img7" alt="...">
                </picture>
              </a>
            </div>
          </div>
